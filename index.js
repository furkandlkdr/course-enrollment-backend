...
app.post('/api/students', async (req, res) => {
    try {
        ...
        const query = `
            ...
            OUTPUT INSERTED.Student_ID INTO @Student_ID
            VALUES (@Name, @Surname, @DOB, @Faculty_ID, GETDATE());
            EXEC GenerateStudentNumber @Student_ID, YEAR(GETDATE()), @Faculty_ID;
        `;
        ...
        res.json({ message: 'Yeni öğrenci başarıyla eklendi.' });
    } catch (err) {
